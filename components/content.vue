...
const menuItems = [
  {
    text: 'GitHub',
    link: 'https://github.com/vittordeaguiar',
    icon: '/icons/github-icon.svg',
  },
  {
    text: 'LinkedIn',
    link: 'https://www.linkedin.com/in/vittordeaguiar/',
...
<template>
  <main class="md:px-96 mt-10 px-8 flex flex-col items-center space-y-8 w-full h-full my-auto">
    <a
