...
<template>
  <header
    class="fixed top-0 left-0 w-full z-20 bg-dark-gray py-2 px-4 sm:px-8 md:px-60 flex items-center justify-between"
  >
    <section class="flex flex-col">
      <h1 class="text-lg sm:text-xl font-semibold">Vittor de Aguiar</h1>
    ...
    <div
      v-if="isMenuOpen"
      class="md:hidden absolute top-12 left-0 w-full bg-dark-gray flex flex-col items-center space-y-2 py-2"
    >
      <a
        v-for="item in menuItems"
        class="cursor-pointer transition-transform transform hover:scale-110"
